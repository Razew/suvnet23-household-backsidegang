...
export const chores: Chore[] = [
	// Smith Family Chores
	{ id: 1, name: "Wash dishes", householdId: 1 },
	{ id: 2, name: "Vacuum living room", householdId: 1 },
	{ id: 3, name: "Mow the lawn", householdId: 1 },
	{ id: 4, name: "Take out trash", householdId: 1 },
	{ id: 5, name: "Clean bathroom", householdId: 1 },

	// Johnson Family Chores
	{ id: 6, name: "Wash dishes", householdId: 2 },
	{ id: 7, name: "Vacuum living room", householdId: 2 },
	{ id: 8, name: "Mow the lawn", householdId: 2 },
	{ id: 9, name: "Take out trash", householdId: 2 },
	{ id: 10, name: "Clean kitchen", householdId: 2 },

	// Williams Family Chores
	{ id: 11, name: "Wash dishes", householdId: 3 },
	{ id: 12, name: "Vacuum living room", householdId: 3 },
	{ id: 13, name: "Mow the lawn", householdId: 3 },
	{ id: 14, name: "Take out trash", householdId: 3 },
	{ id: 15, name: "Clean garage", householdId: 3 },

	// Brown Family Chores
	{ id: 16, name: "Wash dishes", householdId: 4 },
	{ id: 17, name: "Vacuum living room", householdId: 4 },
	{ id: 18, name: "Mow the lawn", householdId: 4 },
	{ id: 19, name: "Take out trash", householdId: 4 },
	{ id: 20, name: "Clean attic", householdId: 4 },

	// Jones Family Chores
	{ id: 21, name: "Wash dishes", householdId: 5 },
	{ id: 22, name: "Vacuum living room", householdId: 5 },
	{ id: 23, name: "Mow the lawn", householdId: 5 },
